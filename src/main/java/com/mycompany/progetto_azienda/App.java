        ...
        do {            
            ...
            switch (sceltaPersona) {
                ...
                case 1:
                    ...
                    vociMenu[2]="2 -->\tVisualizza la lista dei tuoi colleghi";
                ...
                case 2:
                    ...
                    vociMenu=new String[numeroVociMenu];
                    vociMenu[0]="0 -->\tEsci";
                    vociMenu[1]="1 -->\tVisualizza la lista dei dipendenti del tuo riparto";
                    vociMenu[2]="2 -->\tAssegna un compito a un dipendente";
                    vociMenu[3]="3 -->\tApprova richieste ferie";
                    m2=new Menu(vociMenu);
                    break;
                case 3:
                    x=1;
